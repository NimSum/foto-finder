class Photo {
  ...
  updatePhoto(id, type, content) {
    ...
    type === 'title' ? photoFound.title = content
    : type === 'caption' ? photoFound.caption = content
    : type === 'favorite' ? photoFound.favorite = content 
    : type === 'image' ? photoFound.img = content  : false;
